...
class AzureService():
    ...
    :param images: The list of images in base64 format
    ...
    :param images: The list of images in base64 format
    :return: The list of user prompt corresponding to the images
    '''
    ...
    :param user_prompt_parts: The list of user prompt parts (text and base64 images)
    :return: The list of messages to be sent to the API
    '''
